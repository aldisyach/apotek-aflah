    ...
    if ($_GET['act']=='insert') {
     ...
     elseif ($_GET['act']=='delete') {
        if (isset($_GET['id'])) {
            ...
            $query = mysqli_query($mysqli, "DELETE FROM is_obat_keluar WHERE kode_transaksi_keluar='$kode_transaksi'") or die('Ada kesalahan pada query delete : '.mysqli_error($mysqli));
