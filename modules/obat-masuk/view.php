          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      ?>
                          <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="modules/obat-masuk/proses.php?act=delete&id=<?php echo $data['kode_transaksi'];?>" onclick="return confirm('Anda yakin ingin menghapus data <?php echo $data['nama_obat']; ?> ?');">
