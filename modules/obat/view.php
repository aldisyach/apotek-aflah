      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT kode_obat,nama_obat,kategori,harga_beli,harga_jual,satuan,stok FROM is_obat ORDER BY kode_obat DESC")
