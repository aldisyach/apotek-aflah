          ...
          <form role="form" class="form-horizontal" action="modules/obat/proses.php?act=insert" method="POST">
            <div class="box-body">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select class="chosen-select" name="kategori" data-placeholder="-- Pilih --" autocomplete="off" required>
                    <option value="Bebas Tablet">Bebas Tablet</option>
                    <option value=""></option>
                    <option value="Bebas Sirup">Bebas Sirup</option>
                    <option value="Bebas Cairan">Bebas Cairan</option>
                    <option value="Bebas Cream">Bebas Cream</option>
                    <option value="Keras Tablet Dalam (G)">Keras Tablet Dalam (G)</option>
                    <option value="Keras Sirup Dalam (G)">Keras Sirup Dalam (G)</option>
                    <option value="Keras Campuran">Keras Campuran</option>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="nama_obat" autocomplete="off" autofocus="on" required>
                </div>
              </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-5">
                  <div class="input-group">
                    <input type="number" min="1" class="form-control" id="stok" name="stok" value="50" autocomplete="off" required>
                  </div>
                </div>
              </div>
...
elseif ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT kode_obat,nama_obat,kategori,harga_beli,harga_jual,satuan,stok FROM is_obat WHERE kode_obat='$_GET[id]'") 
            ...
            <div class="box-body">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label class="col-sm-2 control-label">Stok</label>
                <div class="col-sm-5">
                  <input type="number" min="1" class="form-control" name="stok" autocomplete="off" value="<?php echo $data['stok']; ?>" required>
                </div>
              </div>
