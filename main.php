  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
          ...
          <div class="modal-dialog">
              <div class="modal-content">
               ...
               <?php elseif ($_SESSION['hak_akses']=='Gudang') : ?>
                <div class="modal-body">
                    <p>Silahkan cek kembali sebelum logout</p>
                </div>
                <div class="modal-footer">
                    <a type="button" class="btn btn-danger" href="logout.php">Sudah</a>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Kembali</button>
                </div>
                <?php else:?>
                   <div class="modal-body">
                    <p>Terima kasih sudah login. Silahkan klik Yes untuk logout. Have a Nice Day</p>
                </div>
                <div class="modal-footer">
                    <a type="button" class="btn btn-danger" href="logout.php">Yes</a>
      ...
      <footer class="main-footer text-center">
        <strong>Copyright &copy; <?php echo date('Y') ?> - <a href="www.aldi-ysc.com">www.aldi-ysc.com</a></strong>
      </footer>
    </div><!-- ./wrapper -->
